...
// Obter o ID da pessoa, o novo status e a observação da solicitação POST
$idPessoa = $_POST['idPessoa'];
$novoStatus = $_POST['status']; // 'PAGO'
$observacao = isset($_POST['observacao']) ? $_POST['observacao'] : ''; // Observação, se fornecida
...
if ($resultadoStatusAtual->num_rows > 0) {
    ...
    if ($statusAtual !== $novoStatus) {
        ...
        $sql = "UPDATE retiro2025 SET SITUACAO='$novoStatus', OBSERVACAO='$observacao' WHERE ID_PESSOA=$idPessoa";
